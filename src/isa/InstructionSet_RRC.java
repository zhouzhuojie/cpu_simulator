...
//		++11)			SR 15	< TR
				Global.SR.set(Global.TR.get(1,1+count-1),16-count);
//				ELSE 						// SHIFT LEFT
			} else {
//		++9)			TR 	< SR 15
				Global.TR.reset();
...
//		++11)			SR 1	< TR
				Global.SR.set(Global.TR.get(15-count+1,15),1);
			}
//			ELSE							// LOGICAL
		} else {			
//		+8)		IF (LR == 0) THEN			// SHIFT RIGHT
...
//		++11)			SR 15	< TR
				Global.SR.set(Global.TR.get(0,count-1),16-count);
//				ELSE						// SHIFT LEFT
			} else {
//		++9)			TR	< SR 15
				Global.TR.reset();
...
//		++11)			SR 0	< TR
				Global.SR.set(Global.TR.get(15-count+1,15),0);
			}
		}
//		13)	Register(RSR) < SR
