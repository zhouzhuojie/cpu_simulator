...
public class Alu {
	...
	public char[] num2char(int b) throws Exception {
		...
		// Copy int b to a positive int bb, in order to avoid the negative
	...
	/*
	 * Added by Leen: This will convert int into 2 words. It's particularly used
	 * for multiplication in ALU
	 */
	...
	/* Changed by Leen */
	// char[] * char[] *******Something have to be done to implete the MUL
	// instruction*********
